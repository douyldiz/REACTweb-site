    ...
    <div className="App">
      <header className="header">
        <a href="#" className="logo">
          <img src="https://www.creativefabrica.com/wp-content/uploads/2021/11/26/HY-logo-design-vector-Graphics-20771410-1.jpg" alt="logo" width="100" height="100" />
        </a>
      ...
      <section className="home">
        <div className="content">
          <h3 className='button'>JOIN THE CLUB</h3>
